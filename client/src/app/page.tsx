        ...
        <main>
            <div className="flex flex-col px-4 w-screen h-screen bg-black">
                <div className="flex flex-row basis-2/12 p-2">
                    ...
                    <div className="basis-2/12 m-2 border-solid border-red border-2"></div>
                    <div className="flex flex-col basis-5/12 m-2">
                        <div className="flex flex-row basis-6/12">
                            <div className="basis-6/12"></div>
                            <div className="basis-6/12 border-solid border-white border-2"></div>
                        </div>
                        <div className="basis-6/12"></div>
                    </div>
                </div>
                <div className="flex flex-col basis-10/12 px-2 pt-2 border-green border-x-2 border-t-2 border-solid">
                    <div className="flex flex-col basis-11/12 space-y-2">
                        <div className="basis-3/12 flex flex-row">  
                            <div className="basis-2/12 border-solid border-white border-2"></div>
                            <div className="basis-10/12 p-2 border-solid border-white border-2">
                                <div className="w-full h-full border-solid border-white border-2"></div>
                            </div>
                        </div>
                        <div className="basis-3/12 flex flex-row">  
                            <div className="basis-2/12 border-solid border-white border-2"></div>
